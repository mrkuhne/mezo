...
vi.mock('@/features/character/pages/CharacterFeedPage', () => ({ CharacterFeedPage: () => <div>Üzenőfal tartalma</div> }))
...
describe('KarakterHubPage', () => {
  test('populated dossier opens directly on the social feed', () => { renderHub(); expect(screen.getByText('Üzenőfal tartalma')).toBeInTheDocument() })
