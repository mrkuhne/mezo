...
// and its primary CTA (Tovább →) uses the house cta-primary pill (F7.4 Mozaik re-face).
test('F7.4 Mozaik shell: coral page + eyebrow/h1 block; primary CTA is the house cta-primary', async () => {
