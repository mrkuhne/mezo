...
export function MesoComparePage() {
  ...
  const goBack = useBackNav('/train/mesocycles/konyvtar')
    ...
    <MozaikPage tone="gold">
      ...
      {!valid ? (
        ...
        <div style={{ padding: '16px 0' }}>
          <GhostState
            lines={2}
            message={'Válassz két lezárt futamot az összevetéshez — az Edzéstervek könyvtár „Összevetés" módjában.'}
            ctaLabel="Könyvtár megnyitása"
            onCta={() => navigate('/train/mesocycles/konyvtar')}
          />
        </div>
      ) : (
        <>
