 ...
 *  ÜVEG (mezo-me75u.4): one sage glass card on Mai — the 3D dawn in a lit well beside the
 *  eyebrow, the lead + slot line, a lit sage pill and a quiet ghost pill. */
export function MorningTrainingCard({
  ...
  return (
    <section className="mtr glass" aria-label="Reggeli edzés-ablak">
      <div className="mtr-head">
        <span className="uv-well mtr-well" aria-hidden="true"><Icon3D name="t-dawn" size={30} /></span>
