...
export const mockQuestHistory: DailyQuest[] = [
  { ...mockQuestDay[1], id: 'qh1' },
  {
    ...
    title: 'A mai tervezett edzés a naptárban van — csináld végig',
    why: 'A megjelenés a legerősebb identitás-szavazat: aki ma edz, az edző ember.',
    targetLabel: 'Mai tervezett edzés teljesítve', metric: 'gym_session_done', xp: 25, status: 'completed',
  ...
  },
  {
    ...
    targetLabel: 'Tevékenységnapló-bejegyzés ma', metric: 'activity_match', xp: 20, status: 'expired', completionMode: 'ACTIVITY',
  },
  {
    ...
    targetLabel: '≥ 2500 ml víz', metric: 'water_target', xp: 15, status: 'completed',
