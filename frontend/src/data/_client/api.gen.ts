...
export interface components {
    schemas: {
        ...
        SimilarDaysResponse: {
            ...
            /**
             * Format: uuid
             * @description A memory_retrieval_run sora (mezo-eq85.10). Akkor és csak akkor null, ha a SIMILAR_DAYS policy ki van kapcsolva (enabled=false): olyankor keresés sem fut, így nincs futás-sor, amire mutathatna, és az items is üres. Ha minden megkérdezett kereső elbukik, a végpont HIBÁT ad (500), nem kitalált üres listát — egy üres lista ezen a felületen azt állítaná, hogy nincs ilyen napod. "Megkérdezett" = a fact- és graph-kereső ilyenkor el sem indul (nem tud napot adni), és nem is számít bele a sikeres keresők számába — enélkül a totális kiesés sosem érte el az 500-at (mezo-eq85.10 fix 2. kör).
             */
        ...
        FeedMessageResponse: {
             ...
             * @enum {string}
             */
            kind: "morning" | "sleep" | "weight" | "midday" | "evening" | "intervention" | "people" | "setup" | "advice" | "hydration";
            eyebrow: string;
            body: string[];
