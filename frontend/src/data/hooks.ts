...
export { useSlotTemplates, useSlotTemplateActions } from '@/data/fuel/slotTemplateHooks'
...
export { useHabitCatalog, useHabitCatalogActions } from '@/data/habit/habitAdminHooks'
