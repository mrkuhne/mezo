...
/** Flat XP per log event (spec §5.1). QUEST/ACTIVITY/HABIT/NEEDS_CLOSE carry their own XP via xpOverride. */
export const XP_VALUES: Record<XpEventType, number> = {
  MEAL: 10, WEIGHT: 10, SLEEP: 10, CHECKIN: 10, MEDICATION: 5,
  GYM: 40, RUN: 30, SPORT: 30, QUEST: 0, ACTIVITY: 0, HABIT: 0, NEEDS_CLOSE: 0,
}
...
export const DAILY_CAPS: Record<XpEventType, number> = {
  ...
  GYM: 1, RUN: 2, SPORT: 2, QUEST: 3, ACTIVITY: 10, HABIT: 10, NEEDS_CLOSE: 1,
}
