...
describe('useNotificationPrefs', () => {
  it('returns all 20 categories with the spec defaults (16 ON, gym leads 30) — +6 feed families, all ON', async () => {
    ...
    await waitFor(() => expect(result.current.prefs).toHaveLength(20))
