...
export const notificationFeedSeed: AppNotificationView[] = [
  ...
  { id: 'nf-4', kind: 'fact_candidate', title: 'Új tény vár jóváhagyásra', body: '„Edzés után 40 perccel esik legjobban az étkezés" — a beszélgetésből emeltem ki.', deeplink: '/mezo/rolad', occurredAt: at(1, '21:40'), readAt: at(1, '22:00') },
  ...
  { id: 'nf-8', kind: 'graph_candidate', title: '2 jelölt vár döntésre a gráfban', body: 'Egy életesemény a tegnapi napodból és egy szezon a lezárult negyedévből.', deeplink: '/mezo/rolad', occurredAt: at(1, '05:10'), readAt: at(1, '09:00') },
