...
export const workout: WorkoutPlan = {
  ...
  exercises: [
    ...
    },
    {
      ...
      prescribedSets: [
        { kind: 'warmup', targetWeightKg: 37.5, targetReps: 12, targetRIR: null },
        { kind: 'warmup', targetWeightKg: 55, targetReps: 6, targetRIR: null },
    ...
    },
    {
      ...
      prescribedSets: [
        { kind: 'warmup', targetWeightKg: 12.5, targetReps: 15, targetRIR: null },
    ...
    },
    {
      ...
      prescribedSets: [
        { kind: 'warmup', targetWeightKg: 10, targetReps: 12, targetRIR: null },
    ...
    },
    {
      ...
      prescribedSets: [
        { kind: 'warmup', targetWeightKg: 15, targetReps: 18, targetRIR: null },
