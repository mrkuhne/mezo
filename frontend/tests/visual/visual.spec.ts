...
/**
 * Self-baselined visual goldens: 20 goto screens + the /ritual Harvest + Release and the
 * /train/review lane + exercise-view click-throughs = 24 screens × 2 themes = 48 snapshots per platform (mezo-mzbz added the two /ritual
 ...
 * train-review and its exercise-view click-through).
 *
