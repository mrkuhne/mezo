...
public class ResetDatabase {
    ...
    public void resetExceptMasterData() {
        ...
        entityManager.createNativeQuery(
            "TRUNCATE TABLE supplement_intake, protocol_item, protocol, water_log, medication_dose, medication, meal_item, meal, recipe_ingredient, recipe, pantry_item, weight_log, sleep_log, check_in, "
