...
public class ResetDatabase {
    ...
    public void resetExceptMasterData() {
        ...
        entityManager.createNativeQuery(
            "TRUNCATE TABLE llm_log_history, gamification_profile, push_subscription, notification_pref, push_log, notification_schedule, coin_event, owned_title, ritual_day, intention_creed, intention_focus, daily_intention, habit_day, habit_def, habit_chain, activity_log, daily_quest, challenge, experiment, prediction, heartbeat_note, memoir, weekly_suggestion, briefing, pattern, daily_summary, memory_embedding, learned_fact, knowledge_fact, ai_message, ai_conversation, supplement_intake, protocol_item, protocol, water_log, medication_dose, medication, meal_item, meal, recipe_ingredient, recipe, pantry_import, pantry_item, weight_log, sleep_log, sleep_goal, fuel_settings, check_in, "
