...
/** Job switch off ⇒ the hourly composite-flag sweep cron bean does not exist (mezo-b3pp.18). */
...
class FlagSweepJobSwitchOffIT extends AbstractIntegrationTest {
    ...
    void testContext_shouldHaveNoJobBean_whenJobSwitchOff() {
        assertThat(context.getBeanProvider(FlagSweepJob.class).getIfAvailable()).isNull();
    }
}
