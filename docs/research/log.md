...
- 2026-09-07 · MEASURE · tool-selection eval re-baseline indult (mezo-ozri.3): az incumbent gemini-2.5-flash 42 esetes futása raw/measurements alá mentve, comparison lap nyitva a három modellre. A két OpenAI futás BLOKKOLT — a kulcs érvényes, de az account egyenlege nulla (429 no credits). Mellékleletek: a mérőpad kapuja provider-tudatos lett, és a padot futtatva kiderült, hogy a `Mi vár még ma a teremben?` eset COMPANION_EMPTY_ANSWER-t dob az incumbenten is.
