...
evaluate(userId, goalId)                              GoalEngineService.java:83
 ...
 └─ GoalEvaluationService.assemble(goal, weightKg, bodyFatPct, segments, guards, dietPreferences, sleepTargetH)  engine/service/GoalEvaluationService.java:84
