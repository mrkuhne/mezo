...
**Frontend — data layer**
- `frontend/src/data/hooks.ts` — the boundary (`useProfile`:75, `useSleep`:79, `usePeople`:106; re-exports `useWeight`:179, `useGoal`/`useGoalCreation`:180)
