...
| `Cél` (goal/strategy) | `/me/goals` (+ `/me/goals/new` wizard) | ✅ | ✅ active goal + **goal creation** (G4a) — "Új cél" **hard-gated** on a complete biometric profile (G6, `GoalGate.tsx`) | ✅ `goal` (G1) + `goal_plan_link` links (G3); insights/factors still mock |
