...
> **Where things live.** Generated 2026-08-28 from commit `6d722600`.
...
- **FE ui** `frontend/src/features/insights`
  - **pages:** ChatPage.tsx, ExperimentsPage.tsx, KnowledgeListPage.tsx, MemoirPage.tsx, MemoryPage.tsx,
  ...
  - **logic:** chatRefs.ts, domains.ts, factCopy.ts, findings.ts, humanizeCron.ts, lifecycle.ts, metricFormat.ts,
    patternHistory.ts, useStickToBottom.ts, useVoiceInput.ts, verdicts.ts
