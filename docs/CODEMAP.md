...
> **Where things live.** Generated 2026-08-27 from commit `7c41c23d`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 119 IT + 16 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `GraphRetractionEventIT`, `GraphRetractionIT`, `GraphServiceIT`, `GraphSwitchOffIT`, `GraphTraversalQueryIT`,
