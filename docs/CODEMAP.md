...
> **Where things live.** Generated 2026-08-30 from commit `8eece0568`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 49 IT + 0 unit
  - **ITs:** `ChallengeGeneratorIT`, `ChallengeJobIT`, `ChallengeJobSwitchOffIT`, `ChallengeOutcomeIT`,
    ...
    `ProactiveApiFeedIT`, `ProactiveApiIT`, `ProactiveApiSwitchOffIT`, `WeeklyLessonServiceIT`,
