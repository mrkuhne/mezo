...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 199 IT + 38 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `AnchoredConversationIT`,
    ...
    `ChatMentionListenerIT`, `ChatReflectionBlockIT`, `ChatSeedReplyFailureIT`, `ChatSeedReplyIT`,
