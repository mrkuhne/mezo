...
> **Where things live.** Generated 2026-08-22 from commit `f2eb271c`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ContextSnapshotAssembler`,
    ...
    `FeedbackLearningJob`, `FeedbackLearningService`, `GraphService`, `HypothesisJob`, `HypothesisPipelineService`,
    `KnowledgeFactService`, `MemoryObservatoryService`, `MemoryRecallService`, `MesoContextAssembler`,
    `MesoReviewGenerator`, `MesoReviewListener`, `MessageFeedbackService`, `MetricDomain`, `MetricKey`,
    `MetricSeriesService`, `PatternDetectionJob`, `PatternDetectionService`, `PatternGate`, `PatternImpactSource`,
    `PatternMonitorService`, `PatternPairDetailService`, `PatternService`, `PearsonCorrelation`,
  ...
  - **other:** `AdvisedAnswer`, `AdvisorRetry`, `AdvisorViolation`, `BiometricsTools`, `ChatHistory`,
    ...
    `PracticeTools`, `RecipeBreakdownLlmAdapter`, `RecordingToolCallback`, `RefsEnvelope`, `SleepShotLlmAdapter`,
    `SlotPlanLlmAdapter`, `StackPlacementLlmAdapter`, `TodayActivitySource`, `TodayQuestSource`, `ToolCallAudit`,
    `ToolCallsEnvelope`, `ToolContexts`, `ToolText`, `TrainTools`, `TurnVerdictCheck`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 75 IT + 12 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`,
    ...
    `GraphEntityPersistenceIT`, `GraphSwitchOffIT`, `HypothesisGatherContextIT`, `HypothesisJobSwitchOffIT`,
...
- **FE ui** `frontend/src/features/insights`
  ...
  - **components:** ChatMessage.tsx, FactCandidateCard.tsx, FeedbackChips.tsx, GrowthWeekCard.tsx,
    ...
    SimilarDayCard.tsx, TokenColumns.tsx
