...
> **Where things live.** Generated 2026-08-30 from commit `40a7eb04`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterCoreCatalog`, `CharacterExpertCatalog`, `CharacterObservationJob`,
    ...
    `ClaimRuling`, `KonziliumProposalRound`, `KonziliumVerdictRound`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 8 IT + 2 unit
  - **ITs:** `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterObservationJobIT`, `CharacterObservationServiceIT`,
    `CharacterPersistenceIT`, `ClaimLifecycleIT`, `KonziliumProposalRoundIT`, `KonziliumVerdictRoundIT`
