...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 168 IT + 30 unit
...
- **scripts/:** backup-live-db.sh, check-beads-backup.mjs, com.mezo.db-backup.plist, gen-codemap.mjs,
