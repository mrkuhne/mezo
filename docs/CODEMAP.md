...
> **Where things live.** Generated 2026-08-26 from commit `bd817c38`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ConsolidationJob`,
    ...
    `PromptMemoryAssembler`, `QuarterlyReviewService`, `Quarters`, `SeasonSuggestion`, `TranscriptionService`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 113 IT + 16 unit
