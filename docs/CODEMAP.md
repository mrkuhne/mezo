...
> **Where things live.** Generated 2026-08-29 from commit `97209928`.
...
- **FE ui** `frontend/src/features/fuel`
  ...
  - **sheets:** AddPantryItemSheet.tsx, AiLogSheet.tsx, CategoryFilterSheet.tsx, EnergyBreakdownSheet.tsx,
    ...
    LogMealSheet.tsx, MealPickerSheet.tsx, MealScoreSheet.tsx, ReceptPickSheet.tsx, ReplanSheet.tsx,
  ...
  - **logic:** amountGuard.ts, buildDayPlan.ts, buildEnergyBreakdown.ts, buildProtocol.ts, compileTemplate.ts,
    ...
    resolveDayType.ts, validateSlotPlan.ts, windowIslands.ts
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/train` — 60 IT + 5 unit
  - **ITs:** `CatalogMediaResolutionIT`, `CatalogWriteContractIT`, `ClosingBlockIT`, `ClosingBlockSwitchOffIT`,
    ...
    `WorkoutServiceIT`, `WorkoutSessionRepositoryChallengeIT`, `WorkoutSetMutationIT`, `WorkoutTodayPrescriptionIT`,
