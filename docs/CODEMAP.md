...
> **Where things live.** Generated 2026-08-31 from commit `83be830bb`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/people`
  ...
  - **services:** `MentionDetectionService`, `PeopleService`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/people` — 3 IT + 0 unit
  - **ITs:** `MentionDetectionServiceIT`, `PeopleContractIT`, `PeopleServiceIT`
