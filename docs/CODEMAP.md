...
> **Where things live.** Generated 2026-08-27 from commit `3256cf52`.
...
| [companion](#companion) | ✓ | 4 | · | · | [companion](features/companion.md), [journal](features/journal.md), [me](features/me.md) |
...
*BE + API + FE-data* · read next: [docs/features/growth.md](features/growth.md) (updated 2026-08-27, done)
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterCoreCatalog`, `CharacterService`
  - **controllers→contract:** `CharacterController`→`CharacterApi`
  - **other:** `ClaimConfidenceHistoryEnvelope`, `ClaimEvidenceEnvelope`, `ClaimFeedbackEnvelope`,
    `ConferenceOutcomeEnvelope`, `ConferenceTranscriptEnvelope`, `ObservationSignalsEnvelope`
- **Contract** `api/feature/character/character.yml` — 5 operations
  - **endpoints:** GET /api/character · GET /api/character/dimension/{key} · GET /api/character/feed ·
    GET /api/character/conference · GET /api/character/conference/{conferenceId}
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 3 IT + 0 unit
  - **ITs:** `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterPersistenceIT`
  - **populators:** `DatabasePopulator`
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ConsolidationJob`,
    ...
    `TranscriptionService`, `WeekContextRenderer`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 126 IT + 16 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `AnchoredConversationIT`,
    ...
    `NoteEmbeddingWriterIT`, `NoteVectorLifecycleBudgetIT`, `NoteVectorLifecycleIT`, `PatternDetectionJobSwitchOffIT`,
...
- **FE data** `frontend/src/data/insights`
  ...
  - **modules:** chat.ts, chatApi.ts, chatHooks.ts, experimentsApi.ts, experimentsHooks.ts, graph.ts, graphApi.ts,
    graphHooks.ts, insights.ts, insightsHooks.ts, knowledge.ts, knowledgeApi.ts, knowledgeHooks.ts, memoirApi.ts,
    memoirHooks.ts, memory.ts, memoryApi.ts, memoryHooks.ts, monitorApi.ts, monitorHooks.ts, patternDetailApi.ts,
...
- **FE ui** `frontend/src/features/insights`
  - **pages:** ChatPage.tsx, ExperimentsPage.tsx, InsightsSection.tsx, KnowledgeListPage.tsx, MemoirPage.tsx,
    MemoryPage.tsx, PatternDetailPage.tsx, PatternsPage.tsx, PredictionsPage.tsx, tabs.ts
...
*FE-data + FE-ui* · read next: [docs/features/growth.md](features/growth.md) (updated 2026-08-27, done) ·
...
- **FE data** `frontend/src/data/me`
  ...
  - **modules:** biometricHooks.ts, biometricProfileApi.ts, biometricsApi.ts, goalApi.ts, goalHooks.ts, goalLinkApi.ts,
    ...
    peopleApi.ts, peopleHooks.ts, sleep.ts, sleepGoal.ts, sleepHooks.ts, sleepShot.ts, weeklyReviewApi.ts,
...
- **FE ui** `frontend/src/features/me`
  ...
  - **components:** AiCallFilters.tsx, AiCallRow.tsx, AiCallUsage.tsx, AiFeatureBreakdown.tsx, AiModelBreakdown.tsx,
    ...
    TimePicker.tsx, WeekDayCard.tsx, WeekDiscoveries.tsx, WeekNextCard.tsx, WeekReviewCard.tsx, WeekScoreBars.tsx,
  ...
  - **logic:** biometricFields.ts, buildTdeeBreakdown.ts, goalLabels.ts, gratitudeStreak.ts, growthJournal.ts,
    ...
    sleepEducation.ts, sleepEscalation.ts, sleepPhases.ts, sleepStats.ts, useChatHandoff.ts, weekNav.ts,
    weightStats.ts
...
*BE + API* · read next: [docs/features/proactive.md](features/proactive.md) (updated 2026-08-27, complete)
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/proactive`
  ...
  - **services:** `ChallengeGenerator`, `ChallengeJob`, `ChallengeOutcomeEvaluator`, `CompanionMessageEventListener`,
    ...
    `ProactivePredictionService`, `ProactiveWeeklySuggestionService`, `WeekReviewSourceAdapter`,
...
*BE + API + FE-data + FE-ui* · read next: [docs/features/growth.md](features/growth.md) (updated 2026-08-27, done)
...
*BE + API + FE-data + FE-ui* · read next: [docs/features/fuel.md](features/fuel.md) (updated 2026-08-16, done) ·
  ...
  [docs/features/train.md](features/train.md) (updated 2026-08-27, done) ·
  [docs/features/_platform-data-layer.md](features/_platform-data-layer.md) (updated 2026-08-27, done)
...
- **Features with no `docs/features/` doc:** `character`, `medication`, `quickinput`, `recipe`
