...
- **FE ui** `frontend/src/features/fuel`
  ...
  - **components:** ContextPanel.tsx, DietSuggestionBanner.tsx, DimensionCard.tsx, FuelEnergyHero.tsx, FuelHorizon.tsx,
    ...
    FuelWaterModule.tsx, FuelWeekDayGlass.tsx, KamraCard.tsx, KeretHero.tsx, MacroCells.tsx, MacroPanel.tsx,
  ...
  - **logic:** amountGuard.ts, backfillWindow.ts, buildDayPlan.ts, buildEnergyBreakdown.ts, buildProtocol.ts,
    ...
    projectStackDay.ts, recipeRole.ts, resolveDayType.ts, scoreArithmetic.ts, scoreTone.ts, stackBands.ts,
    stackPresentation.ts, useStackIntakeToggle.ts, usualMeals.ts, validateSlotPlan.ts
