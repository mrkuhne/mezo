...
> **Where things live.** Generated 2026-08-29 from commit `e8bef33c`.
...
- **FE ui** `frontend/src/features/me`
  ...
  - **components:** AiCallFilters.tsx, AiCallRow.tsx, AiCallUsage.tsx, AiFeatureBreakdown.tsx, AiModelBreakdown.tsx,
    ...
    GoalPlanSlots.tsx, GoalRecept.tsx, GoalTimeline.tsx, GratitudeRows.tsx, GratitudeStreakCard.tsx,
  ...
  - **logic:** biometricFields.ts, buildTdeeBreakdown.ts, goalLabels.ts, gratitudeStreak.ts, growthJournal.ts,
    habitMetricPalette.ts, knowledgeNodeVisuals.ts, llmCallFormat.ts, nightContent.ts, nightFlow.ts, nightTrace.ts,
    notificationForecast.ts, sleepEducation.ts, sleepEscalation.ts, sleepPhases.ts, sleepStats.ts, useChatHandoff.ts,
