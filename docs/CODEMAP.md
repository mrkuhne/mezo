...
> **Where things live.** Generated 2026-08-28 from commit `a0b71715`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterCoreCatalog`, `CharacterExpertCatalog`, `CharacterObservationJob`,
    `CharacterObservationService`, `CharacterService`, `CharacterSignalReads`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 5 IT + 2 unit
  - **ITs:** `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterObservationJobIT`, `CharacterObservationServiceIT`,
    `CharacterPersistenceIT`
  - **populators:** `CheckInPopulator`, `DatabasePopulator`, `JournalPopulator`, `MealPopulator`,
