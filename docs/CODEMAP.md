...
> **Where things live.** Generated 2026-08-22 from commit `b8ad1b98`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 81 IT + 12 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`,
    ...
    `GraphCandidateApiIT`, `GraphEntityPersistenceIT`, `GraphPromotionEventIT`, `GraphPromotionServiceIT`,
    `GraphPromotionSwitchOffIT`, `GraphServiceIT`, `GraphSwitchOffIT`, `HypothesisGatherContextIT`,
    ...
    `PatternDetectionJobSwitchOffIT`, `PatternDetectionServiceIT`, `PromptMemoryAssemblerIT`,
...
- **FE data** `frontend/src/data/insights`
  - **hooks (via `@/data/hooks`):** `NEW_CHAT`, `useChat`, `useChatActions`, `useConversations`,
    ...
    `useLifeEventActions`, `useLifeEventCandidates`, `useLlmUsage`, `useMemoir`, `useMemoryOverview`,
    `useMemorySummaries`, `usePatternActions`, `usePatternMonitor`, `usePatternPairDetail`, `usePatterns`,
    `usePredictions`, `useSimilarDays`, `useTranscribe`, `useWeekly`
