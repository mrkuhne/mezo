...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/proactive`
  ...
  - **services:** `ChallengeGenerator`, `ChallengeJob`, `ChallengeOutcomeEvaluator`, `CompanionMessageEventListener`,
    ...
    `ExperimentProposalGenerator`, `FeedMessageKindService`, `GrowthDigestBlock`, `HighlightCitationSourceAdapter`,
    `InterventionEventListener`, `InterventionService`, `MemoirGenerator`, `MemoirJob`, `MetricWindowEvaluator`,
    ...
    `WeekReviewSourceAdapter`, `WeeklyLessonService`, `WeeklyReviewDigestService`, `WeeklyReviewGenerator`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 44 IT + 0 unit
  - **ITs:** `ChallengeGeneratorIT`, `ChallengeJobIT`, `ChallengeJobSwitchOffIT`, `ChallengeOutcomeIT`,
    ...
    `ExperimentPersistenceIT`, `ExperimentProposalGeneratorIT`, `GrowthDigestBlockIT`, `HighlightCitationIT`,
    `InterventionConfigIT`, `InterventionServiceIT`, `InterventionSwitchOffIT`, `MemoirGeneratorIT`, `MemoirJobIT`,
    ...
    `ProactiveApiIT`, `ProactiveApiSwitchOffIT`, `WeeklyLessonServiceIT`, `WeeklyReviewControllerIT`,
