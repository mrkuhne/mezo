...
<<<<<<< HEAD
> **Where things live.** Generated 2026-08-23 from commit `d9bdbc70`.
=======
> **Where things live.** Generated 2026-08-23 from commit `d2bc9339`.
>>>>>>> 16082170 (feat(scripts): brand-new-user DB purge script + IT (mezo-rcsy))
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ConsolidationJob`,
    ...
    `PeriodSummaryService`, `PromptMemoryAssembler`, `TranscriptionService`
  ...
  - **other:** `AdvisedAnswer`, `AdvisorRetry`, `AdvisorViolation`, `BiometricsTools`, `ChatHistory`,
    ...
    `PatternEvidenceEnvelope`, `PracticeTools`, `RecalledMemoriesEnvelope`, `RecipeBreakdownLlmAdapter`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 97 IT + 14 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `PeriodSummaryPersistenceIT`, `PeriodSummaryServiceIT`, `PromptMemoryAssemblerIT`, `PromptMemoryAssemblerShadowIT`,
    `PromptMemoryAssemblerSwitchOffIT`, `ToolSelectionEvalIT`, `TurnEmbeddingListenerIT`, `TurnEmbeddingSwitchOffIT`,
    `TurnVerdictCheckIT`
...
- **scripts/:** backup-live-db.sh, com.mezo.db-backup.plist, gen-codemap.mjs, gen-codemap.test.mjs,
  import-exercise-images.mjs, lint-docs.mjs, lint-liquibase.mjs, purge-restart.sql
