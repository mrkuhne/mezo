...
> **Where things live.** Generated 2026-08-24 from commit `06b389bd`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 106 IT + 15 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `FlagEvaluatorStressSleepIT`, `FlagPropertiesIT`, `GraphApiIT`, `GraphCandidateApiIT`, `GraphEntityPersistenceIT`,
