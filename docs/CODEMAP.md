...
> **Where things live.** Generated 2026-08-25 from commit `845f811d`.
...
*BE + API + FE-data + FE-ui* · read next: [docs/features/fuel.md](features/fuel.md) (updated 2026-08-16, done) ·
  ...
  [docs/features/train.md](features/train.md) (updated 2026-08-25, done) ·
  [docs/features/_platform-data-layer.md](features/_platform-data-layer.md) (updated 2026-08-21, done)
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/train`
  ...
  - **services:** `CatalogMediaResolver`, `ClosingBlockService`, `ExerciseCatalogService`, `ExerciseHistoryResolver`,
    ...
    `MesoWeeks`, `MesocycleReportService`, `MuscleGroup`, `Prescription`, `PriorityTier`, `ProgressionDecider`,
    `RunningService`, `SetRecommendationService`, `SportService`, `TrainService`, `VolumeArcService`, `VolumeDecider`,
  ...
  - **other:** `ClosingBlockGate`, `ExerciseCatalogLoader`, `GymExerciseJson`, `GymSignalCalculator`,
    ...
    `VolumeRecomputeJson`
- **Contract** `api/feature/train/train.yml` — 54 operations
...
- **FE ui** `frontend/src/features/train`
  ...
  - **components:** ActiveMesoCard.tsx, ArchivedMesoCard.tsx, ChallengeCard.tsx, ChallengesCarousel.tsx,
    ...
    MorningTrainingCard.tsx, MuscleArcSwitch.tsx, MusclePriorityPicker.tsx, PeakFitCard.tsx, PhaseCurveBars.tsx,
    PhaseDots.tsx, PlannedMesoCard.tsx, PlannerExerciseRow.tsx, PrepExerciseCard.tsx, PrepHero.tsx,
  ...
  - **logic:** agenda.ts, challengeOutcome.ts, dayStripItems.ts, exerciseDefaults.ts, growthForecast.ts,
    ...
    weekZone.ts, weeklyLoad.ts, workoutCardMeta.ts, workoutState.ts
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/train` — 59 IT + 5 unit
  - **ITs:** `CatalogMediaResolutionIT`, `CatalogWriteContractIT`, `ClosingBlockIT`, `ClosingBlockSwitchOffIT`,
    ...
    `WarmupExclusionIT`, `WeeklyScheduledActivityServiceIT`, `WorkoutAutoCloseIT`, `WorkoutContractIT`,
