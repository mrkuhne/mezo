...
> **Where things live.** Generated 2026-08-31 from commit `6e5adc86e`.
...
- **FE ui** `frontend/src/features/character`
  - **pages:** KarakterHubPage.tsx
  - **components:** MaturityRing.tsx, PersonaOrb.tsx
  - **root:** character.css, dossierState.ts, expertColors.ts
