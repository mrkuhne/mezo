...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatMentionListener`, `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ConsolidationJob`,
    ...
    `MemoryContextRenderer`, `MemoryContextSelector`, `MemoryContextService`, `MemoryObservatoryService`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 157 IT + 26 unit
