...
> **Where things live.** Generated 2026-08-21 from commit `bf0198e4`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **other:** `AdvisedAnswer`, `AdvisorRetry`, `AdvisorViolation`, `BiometricsTools`, `ChatHistory`,
    ...
    `CompanionToolRegistry`, `EmbeddingPort`, `FakeCompanionLlm`, `FakeEmbeddingAdapter`, `FuelTools`,
    `GeminiCompanionLlm`, `GeminiEmbeddingAdapter`, `GeminiRoundUsage`, `GeminiRoundUsageAdvisor`,
    `GeminiUsageExtractor`, `GoalTools`, `GrowthTools`, `HabitSuggestLlmAdapter`, `InsightsTools`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 64 IT + 11 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`, `ChatServiceIT`,
    ...
    `NoteEmbeddingWriterIT`, `PatternDetectionJobSwitchOffIT`, `PatternDetectionServiceIT`, `ToolSelectionEvalIT`,
