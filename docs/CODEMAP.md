...
> **Where things live.** Generated 2026-08-23 from commit `0417cd88`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 95 IT + 14 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`,
    ...
    `CompanionToolsRenderIT`, `CompanionTranscribeApiIT`, `ConsolidationJobIT`, `ConsolidationJobSwitchOffIT`,
    `ConsolidationPropertiesIT`, `ContextSnapshotAssemblerIT`, `ConversationServiceIT`, `DailySummaryJobIT`,
    `DailySummaryJobSwitchOffIT`, `DailySummaryServiceIT`, `FactCandidateServiceIT`, `FactExtractionServiceIT`,
    `FakeEmbeddingAdapterIT`, `FeedbackLearningJobSwitchOffIT`, `FeedbackLearningPropertiesIT`,
    `FeedbackLearningServiceIT`, `FeedbackRollupPersistenceIT`, `GraphApiIT`, `GraphCandidateApiIT`,
    `GraphEntityPersistenceIT`, `GraphMaintenanceJobSwitchOffIT`, `GraphMaintenanceServiceIT`, `GraphPromotionEventIT`,
    `GraphPromotionServiceIT`, `GraphPromotionServiceReconcileIsolationIT`, `GraphPromotionSwitchOffIT`,
    `GraphPromptAssemblerIT`, `GraphServiceIT`, `GraphSwitchOffIT`, `GraphTraversalQueryIT`,
    `HypothesisGatherContextIT`, `HypothesisJobSwitchOffIT`, `HypothesisPipelineServiceIT`, `KnowledgeFactServiceIT`,
    `LearnedFactPersistenceIT`, `LifeEventExtractionServiceIT`, `MemoryEmbeddingAnnQueryIT`,
