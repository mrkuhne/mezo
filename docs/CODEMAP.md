...
> **Where things live.** Generated 2026-08-22 from commit `8030a5ef`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ContextSnapshotAssembler`,
    ...
    `FeedbackLearningJob`, `FeedbackLearningService`, `GraphEdgeStructurer`, `GraphEdgeSuggestion`,
    `GraphPromotionService`, `GraphService`, `HypothesisJob`, `HypothesisPipelineService`, `KnowledgeFactService`,
    `MemoryObservatoryService`, `MemoryRecallService`, `MesoContextAssembler`, `MesoReviewGenerator`,
    ...
    `PatternPairDetailService`, `PatternService`, `PearsonCorrelation`, `PromptMemoryAssembler`,
