...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `AdviceRankPort`, `ChatDaySignalService`, `ChatMemoryContextAdapter`, `ChatMentionListener`,
    ...
    `FlagOutcome`, `FlagRaisedEvent`, `FlagRule`, `FlagService`, `FlagSweepJob`, `FlagTraceCopy`,
    `FlagTraceReadService`, `FlagTraceWriter`, `FlagVerdict`, `GearClassifier`, `GraphEdgeLineRenderer`,
    ...
    `PersonExtractionService`, `PersonGraphEdgeAdapter`, `PersonalBaselineContext`, `PersonalContextAssembler`,
    ...
    `ReflectionReplyService`, `SeasonSuggestion`, `SimilarDaysRecall`, `TestPlanValidator`, `TextSignalCatchUpService`,
    ...
    `TurnGearRouter`, `TurnPhase`, `TurnPlan`, `TurnPlanParser`, `TurnPlanner`, `TurnProvenance`, `UnavailableReason`,
    `ValidatedPlan`, `WeekContextRenderer`, `WeeklyScoreService`, `WeightByDateSupport`
  ...
  - **config:** `CompanionFeatureFlag`, `CompanionProperties`, `ConversationProperties`, `DayEvaluationProperties`,
    ...
    `MemoryPlatformProperties`, `ModelTier`, `PersonalRecordProperties`, `ProfileProperties`, `QuarterlyProperties`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 255 IT + 86 unit
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/proactive`
  ...
  - **services:** `AdviceActionCatalog`, `AdviceApplyService`, `AdviceCandidate`, `AdviceCardService`,
    ...
    `FatigueEvidenceCollector`, `FeatureAbandonmentDetector`, `FeedMessageKindService`, `FlatFeedbackDetector`,
