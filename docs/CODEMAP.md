...
> **Where things live.** Generated 2026-08-31 from commit `9f4b01c62`.
...
- **FE ui** `frontend/src/features/insights`
  ...
  - **logic:** chatRefs.ts, diagnosisCopy.ts, domains.ts, factCopy.ts, findings.ts, humanizeCron.ts, lifecycle.ts,
    metricFormat.ts, patternHistory.ts, useStickToBottom.ts, useVoiceInput.ts, verdicts.ts
