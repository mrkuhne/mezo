...
> **Where things live.** Generated 2026-08-24 from commit `4b35da45`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ConsolidationJob`,
    ...
    `FeedMessageKindSource`, `FeedbackLearningJob`, `FeedbackLearningService`, `FlagKey`, `GraphEdgeLineRenderer`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 105 IT + 15 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `FeedbackLearningPropertiesIT`, `FeedbackLearningServiceIT`, `FeedbackRollupPersistenceIT`, `FlagPropertiesIT`,
    `GraphApiIT`, `GraphCandidateApiIT`, `GraphEntityPersistenceIT`, `GraphMaintenanceJobSwitchOffIT`,
    `GraphMaintenanceServiceIT`, `GraphPromotionEventIT`, `GraphPromotionServiceIT`,
    `GraphPromotionServiceReconcileIsolationIT`, `GraphPromotionSwitchOffIT`, `GraphPromptAssemblerIT`,
    `GraphServiceIT`, `GraphSwitchOffIT`, `GraphTraversalQueryIT`, `HypothesisGatherContextIT`,
    `HypothesisJobSwitchOffIT`, `HypothesisPipelineServiceIT`, `KnowledgeFactServiceIT`, `LearnedFactPersistenceIT`,
    `LifeEventExtractionServiceIT`, `MemoryEmbeddingAnnQueryIT`, `MemoryEmbeddingRepositoryIT`,
    ...
    `PeriodSummaryServiceIT`, `ProfileAssemblerIT`, `ProfileAssemblerJobIT`, `ProfileAssemblerJobSwitchOffIT`,
    `ProfilePromptAssemblerIT`, `ProfilePropertiesIT`, `ProfileSourceFindersIT`, `PromptMemoryAssemblerIT`,
