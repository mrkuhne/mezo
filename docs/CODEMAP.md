...
> **Where things live.** Generated 2026-08-24 from commit `4372d34f`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ConsolidationJob`,
    ...
    `FlagEvaluator`, `FlagKey`, `FlagRaise`, `FlagService`, `FlagSweepJob`, `GraphEdgeLineRenderer`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/train` — 57 IT + 4 unit
  - **ITs:** `CatalogMediaResolutionIT`, `CatalogWriteContractIT`, `ClosingBlockIT`, `ClosingBlockSwitchOffIT`,
    ...
    `MesoTemplateVolumeBackfillSqlIT`, `MesoTemplateVolumeFlagIT`, `MesocycleCloseReportIT`,
