...
<<<<<<< HEAD
> **Where things live.** Generated 2026-08-27 from commit `8cdae43e`.
=======
> **Where things live.** Generated 2026-08-27 from commit `f8ecb22f`.
>>>>>>> origin/main
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **other:** `ClaimConfidenceHistoryEnvelope`, `ClaimEvidenceEnvelope`, `ClaimFeedbackEnvelope`,
    `ConferenceOutcomeEnvelope`, `ConferenceTranscriptEnvelope`, `ObservationDimensionKeysEnvelope`,
    `ObservationSignalsEnvelope`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 127 IT + 17 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `AnchoredConversationIT`,
    ...
    `LearnedFactPersistenceIT`, `LifeEventExtractionServiceIT`, `MeWeekControllerIT`, `MeWeekServiceFuelFetchCountIT`,
    ...
    `NoteEmbeddingSwitchOffIT`, `NoteEmbeddingWriterIT`, `NoteVectorLifecycleBudgetIT`, `NoteVectorLifecycleIT`,
...
- **ui:** AdherenceBar.tsx, Chip.tsx, CoachBubble.tsx, CountUp.tsx, Cta.tsx, DatePicker.tsx, DayNavigator.tsx,
  ...
  ToastProvider.tsx, Toggle.tsx, ToolChip.tsx, ToolChipRow.tsx, TrendChart.tsx, clay/clay-icons.svg,
  clay/clay-spots.svg, clay/index.tsx, sectionLabel.ts
...
- **`ResetDatabase` TRUNCATE list** — 88 tables; a new owned domain table MUST be added here in the same change:
  - **tables:** `activity_log`, `ai_conversation`, `ai_message`, `app_notification`, `biometric_profile`, `challenge`,
    ...
    `daily_intention`, `daily_quest`, `daily_summary`, `decision_entry`, `exercise`, `exercise_feedback`,
