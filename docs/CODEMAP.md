...
> **Where things live.** Generated 2026-08-31 from commit `f60ec02ae`.
...
- **FE ui** `frontend/src/features/insights`
  ...
  - **logic:** chatRefs.ts, diagnosisCatalog.ts, diagnosisCopy.ts, domains.ts, factCopy.ts, findings.ts,
    humanizeCron.ts, lifecycle.ts, metricFormat.ts, patternHistory.ts, toolDomains.ts, useStickToBottom.ts,
