...
> **Where things live.** Generated 2026-08-31 from commit `779b7e93b`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterBootstrapService`, `CharacterConferenceJob`, `CharacterConferenceService`,
    `CharacterCoreCatalog`, `CharacterExpertCatalog`, `CharacterHistoryReads`, `CharacterObservationJob`,
    `CharacterObservationService`, `CharacterService`, `CharacterSignalReads`, `ClaimLifecycle`, `ClaimProposal`,
    `ClaimRuling`, `ExpertEvidence`, `KonziliumProposalRound`, `KonziliumVerdictRound`, `PortraitWriter`
...
- **Contract** `api/feature/character/character.yml` — 6 operations
  - **endpoints:** GET /api/character · GET /api/character/dimension/{key} · GET /api/character/feed ·
    POST /api/character/bootstrap · GET /api/character/conference · GET /api/character/conference/{conferenceId}
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 12 IT + 4 unit
  - **ITs:** `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterBootstrapIT`, `CharacterConferenceJobIT`,
    `CharacterConferenceServiceIT`, `CharacterHistoryReadsIT`, `CharacterObservationJobIT`,
    `CharacterObservationServiceIT`, `CharacterPersistenceIT`, `ClaimLifecycleIT`, `KonziliumProposalRoundIT`,
    `KonziliumVerdictRoundIT`
  - **populators:** `CheckInPopulator`, `DailySummaryPopulator`, `DatabasePopulator`, `JournalPopulator`,
    `KnowledgeFactPopulator`, `MealPopulator`, `PantryItemPopulator`, `PatternPopulator`, `UserPopulator`
...
*BE + API + FE-data + FE-ui* · read next: [docs/features/goal-engine.md](features/goal-engine.md) (updated 2026-08-15, done) ·
  [docs/features/train.md](features/train.md) (updated 2026-08-30, done) ·
  [docs/features/_platform-data-layer.md](features/_platform-data-layer.md) (updated 2026-08-27, done)
