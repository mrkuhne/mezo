...
> **Where things live.** Generated 2026-08-24 from commit `4be601c5`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 37 IT + 0 unit
  - **ITs:** `ChallengeGeneratorIT`, `ChallengeJobIT`, `ChallengeJobSwitchOffIT`, `ChallengeOutcomeIT`,
    ...
    `ExperimentPersistenceIT`, `ExperimentProposalGeneratorIT`, `GrowthDigestBlockIT`, `MemoirGeneratorIT`,
    `MemoirJobIT`, `MemoirJobSwitchOffIT`, `MemoirPersistenceIT`, `OverloadChallengeGeneratorIT`,
