...
> **Where things live.** Generated 2026-08-31 from commit `0504024a5`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterBootstrapService`, `CharacterConferenceJob`, `CharacterConferenceService`,
    `CharacterCoreCatalog`, `CharacterExpertCatalog`, `CharacterHistoryReads`, `CharacterMonthlyJob`,
    `CharacterMonthlyService`, `CharacterObservationJob`, `CharacterObservationService`, `CharacterService`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 13 IT + 5 unit
  - **ITs:** `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterBootstrapIT`, `CharacterConferenceJobIT`,
    ...
    `CharacterObservationJobIT`, `CharacterObservationServiceIT`, `CharacterPersistenceIT`, `ClaimLifecycleIT`,
    `KonziliumProposalRoundIT`, `KonziliumVerdictRoundIT`
