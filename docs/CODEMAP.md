...
> **Where things live.** Generated 2026-08-30 from commit `1cf6f77ee`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterConferenceJob`, `CharacterConferenceService`, `CharacterCoreCatalog`,
    `CharacterExpertCatalog`, `CharacterObservationJob`, `CharacterObservationService`, `CharacterService`,
    `CharacterSignalReads`, `ClaimLifecycle`, `ClaimProposal`, `ClaimRuling`, `KonziliumProposalRound`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 10 IT + 2 unit
