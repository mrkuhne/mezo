...
> **Where things live.** Generated 2026-08-31 from commit `81a823247`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 129 IT + 17 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `AnchoredConversationIT`,
    ...
    `GraphPromptAssemblerRefsCapIT`, `GraphRetractionEventIT`, `GraphRetractionIT`, `GraphServiceIT`,
