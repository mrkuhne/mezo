...
> **Where things live.** Generated 2026-08-27 from commit `47e9d066`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/proactive`
  ...
  - **services:** `ChallengeGenerator`, `ChallengeJob`, `ChallengeOutcomeEvaluator`, `CompanionMessageEventListener`,
    ...
    `ProactivePredictionService`, `ProactiveWeeklySuggestionService`, `WeeklyReviewGenerator`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 41 IT + 0 unit
  - **ITs:** `ChallengeGeneratorIT`, `ChallengeJobIT`, `ChallengeJobSwitchOffIT`, `ChallengeOutcomeIT`,
    ...
    `ProactiveApiSwitchOffIT`, `WeeklyReviewGeneratorIT`, `WeeklySuggestionGeneratorIT`, `WeeklySuggestionJobIT`,
