...
> **Where things live.** Generated 2026-08-31 from commit `0365bd08f`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 16 IT + 5 unit
  - **ITs:** `CharacterApiCompanionOffIT`, `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterBootstrapIT`,
    ...
    `CharacterPromptAssemblerIT`, `CharacterPromptWiringIT`, `ClaimLifecycleIT`, `KonziliumProposalRoundIT`,
