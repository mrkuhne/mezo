...
> **Where things live.** Generated 2026-08-31 from commit `a9e610f7f`.
...
- **FE ui** `frontend/src/features/insights`
  ...
  - **logic:** chatRefs.ts, diagnosisCatalog.ts, diagnosisCopy.ts, domains.ts, factCopy.ts, findings.ts,
    humanizeCron.ts, lifecycle.ts, metricFormat.ts, patternHistory.ts, useStickToBottom.ts, useVoiceInput.ts,
    verdicts.ts
