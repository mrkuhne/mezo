...
> **Where things live.** Generated 2026-08-30 from commit `ef1963b7`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterCoreCatalog`, `CharacterExpertCatalog`, `CharacterObservationJob`,
    `CharacterObservationService`, `CharacterService`, `CharacterSignalReads`, `ClaimProposal`,
    `KonziliumProposalRound`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 6 IT + 2 unit
  - **ITs:** `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterObservationJobIT`, `CharacterObservationServiceIT`,
    `CharacterPersistenceIT`, `KonziliumProposalRoundIT`
