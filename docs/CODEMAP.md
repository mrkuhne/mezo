...
> **Where things live.** Generated 2026-08-21 from commit `2cc6151f`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **repositories:** `AiConversationRepository`, `AiMessageRepository`, `DailySummaryRepository`,
    `KnowledgeFactRepository`, `LearnedFactRepository`, `MemoryEmbeddingRepository`, `MessageFeedbackRepository`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 60 IT + 11 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`, `ChatServiceIT`,
    ...
    `FactCandidateServiceIT`, `FactExtractionServiceIT`, `FakeEmbeddingAdapterIT`, `HypothesisGatherContextIT`,
    ...
    `MetricSeriesServiceIT`, `PatternDetectionJobSwitchOffIT`, `PatternDetectionServiceIT`, `ToolSelectionEvalIT`,
  ...
  - **populators:** `ActivityPopulator`, `AiConversationPopulator`, `AiMessagePopulator`, `BiometricProfilePopulator`,
    `CheckInPopulator`, `DailySummaryPopulator`, `DatabasePopulator`, `FeedbackPopulator`, `GamificationPopulator`,
    `GoalPlanLinkPopulator`, `GoalPopulator`, `HabitPopulator`, `IntentionPopulator`, `JournalPopulator`,
    `KnowledgeFactPopulator`, `LearnedFactPopulator`, `LevelUpEventPopulator`, `LlmLogPopulator`, `MealPopulator`,
    `MedicationDosePopulator`, `MedicationPopulator`, `MemoryEmbeddingPopulator`, `MentionPopulator`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/ritual` — 4 IT + 0 unit
  - **ITs:** `RitualApiIT`, `RitualDayEntityIT`, `RitualReflectionEventIT`, `RitualSwitchOffIT`
...
- **populators (`support/populator/`):** `ActivityPopulator`, `AiConversationPopulator`, `AiMessagePopulator`,
  ...
  `WeightLogPopulator`
- **`ResetDatabase` TRUNCATE list** — 76 tables; a new owned domain table MUST be added here in the same change:
  - **tables:** `activity_log`, `ai_conversation`, `ai_message`, `app_notification`, `biometric_profile`, `challenge`,
    ...
    `pattern_event`, `perk_unlock`, `person`, `prediction`, `protocol`, `protocol_item`, `push_log`,
