...
> **Where things live.** Generated 2026-08-22 from commit `5025b78a`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ContextSnapshotAssembler`,
    ...
    `GraphPromotionListener`, `GraphPromotionService`, `GraphService`, `HypothesisJob`, `HypothesisPipelineService`,
    `KnowledgeFactPromotedEvent`, `KnowledgeFactService`, `MemoryObservatoryService`, `MemoryRecallService`,
    `MesoContextAssembler`, `MesoReviewGenerator`, `MesoReviewListener`, `MessageFeedbackService`, `MetricDomain`,
    `MetricKey`, `MetricSeriesService`, `PatternConfirmedEvent`, `PatternDetectionJob`, `PatternDetectionService`,
    `PatternGate`, `PatternImpactSource`, `PatternMonitorService`, `PatternPairDetailService`, `PatternService`,
    `PearsonCorrelation`, `PromptMemoryAssembler`, `TranscriptionService`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 79 IT + 12 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`,
    ...
    `GraphEntityPersistenceIT`, `GraphPromotionEventIT`, `GraphPromotionServiceIT`, `GraphPromotionSwitchOffIT`,
    `GraphServiceIT`, `GraphSwitchOffIT`, `HypothesisGatherContextIT`, `HypothesisJobSwitchOffIT`,
    `HypothesisPipelineServiceIT`, `KnowledgeFactServiceIT`, `LearnedFactPersistenceIT`, `MemoryEmbeddingAnnQueryIT`,
    ...
    `NoteEmbeddingWriterIT`, `PatternDetectionJobSwitchOffIT`, `PatternDetectionServiceIT`, `PromptMemoryAssemblerIT`,
