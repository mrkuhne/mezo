...
> **Where things live.** Generated 2026-08-24 from commit `80fb0ada`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 110 IT + 15 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `FlagEvaluationListenerIT`, `FlagEvaluatorMomentumRecoveryIT`, `FlagEvaluatorStressSleepIT`, `FlagPropertiesIT`,
    `FlagServiceIT`, `FlagSweepJobSwitchOffIT`, `GraphApiIT`, `GraphCandidateApiIT`, `GraphEntityPersistenceIT`,
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/proactive`
  ...
  - **services:** `ChallengeGenerator`, `ChallengeJob`, `ChallengeOutcomeEvaluator`, `CompanionMessageEventListener`,
    ...
    `ExperimentProposalGenerator`, `FeedMessageKindService`, `GrowthDigestBlock`, `InterventionEventListener`,
    `InterventionService`, `MemoirGenerator`, `MemoirJob`, `MetricWindowEvaluator`, `OverloadChallengeGenerator`,
    `PatternImpactService`, `PredictionGenerator`, `PredictionJob`, `PredictionValidationService`,
    `ProactiveChallengeService`, `ProactiveExperimentService`, `ProactiveFeedService`, `ProactiveMemoirService`,
    `ProactivePredictionService`, `ProactiveWeeklySuggestionService`, `WeeklySuggestionGenerator`,
    `WeeklySuggestionJob`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 40 IT + 0 unit
  - **ITs:** `ChallengeGeneratorIT`, `ChallengeJobIT`, `ChallengeJobSwitchOffIT`, `ChallengeOutcomeIT`,
    ...
    `CompanionMessagePersistenceIT`, `ExperimentJobIT`, `ExperimentJobSwitchOffIT`, `ExperimentOutcomeIT`,
    `ExperimentPersistenceIT`, `ExperimentProposalGeneratorIT`, `GrowthDigestBlockIT`, `InterventionConfigIT`,
    `InterventionServiceIT`, `InterventionSwitchOffIT`, `MemoirGeneratorIT`, `MemoirJobIT`, `MemoirJobSwitchOffIT`,
    `MemoirPersistenceIT`, `OverloadChallengeGeneratorIT`, `PredictionGeneratorIT`, `PredictionJobIT`,
    ...
    `ProactiveApiSwitchOffIT`, `WeeklySuggestionGeneratorIT`, `WeeklySuggestionJobIT`,
