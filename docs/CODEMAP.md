...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 167 IT + 26 unit
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 68 IT + 5 unit
