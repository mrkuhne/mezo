...
> **Where things live.** Generated 2026-08-22 from commit `96dbae6a`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 76 IT + 12 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`,
    ...
    `GraphEntityPersistenceIT`, `GraphServiceIT`, `GraphSwitchOffIT`, `HypothesisGatherContextIT`,
    ...
    `NoteEmbeddingSwitchOffIT`, `NoteEmbeddingWriterIT`, `PatternDetectionJobSwitchOffIT`, `PatternDetectionServiceIT`,
    `PromptMemoryAssemblerIT`, `PromptMemoryAssemblerSwitchOffIT`, `ToolSelectionEvalIT`, `TurnEmbeddingListenerIT`,
