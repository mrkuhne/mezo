...
> **Where things live.** Generated 2026-08-22 from commit `b01e255a`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **repositories:** `AiConversationRepository`, `AiMessageRepository`, `DailySummaryRepository`,
    `FeedbackRollupRepository`, `KnowledgeFactRepository`, `LearnedFactRepository`, `MemoryEmbeddingRepository`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 68 IT + 11 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`, `ChatServiceIT`,
    ...
    `LearnedFactPersistenceIT`, `MemoryEmbeddingRepositoryIT`, `MemoryEmbeddingWriterIT`, `MemoryRecallServiceIT`,
