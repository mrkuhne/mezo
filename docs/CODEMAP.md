...
> **Where things live.** Generated 2026-08-27 from commit `f15e0676`.
...
*BE + API* · read next: [docs/features/companion.md](features/companion.md) (updated 2026-08-27, mixed) ·
  [docs/features/journal.md](features/journal.md) (updated 2026-08-27, done)
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 117 IT + 16 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `PromptMemoryAssemblerShadowIT`, `PromptMemoryAssemblerSwitchOffIT`, `QuarterlyPropertiesIT`,
    `QuarterlyReviewJobIT`, `QuarterlyReviewJobProfileSwitchOffIT`, `QuarterlyReviewJobSwitchOffIT`,
    `QuarterlyReviewPayloadIT`, `QuarterlyReviewServiceIT`, `SleepLogDetailRenderIT`, `ToolSelectionEvalIT`,
...
*FE-data* · read next: [docs/features/insights.md](features/insights.md) (updated 2026-08-27, mixed)
...
*FE-data + FE-ui* · read next: [docs/features/companion.md](features/companion.md) (updated 2026-08-27, mixed) ·
  [docs/features/insights.md](features/insights.md) (updated 2026-08-27, mixed)
...
*BE + API + FE-data* · read next: [docs/features/journal.md](features/journal.md) (updated 2026-08-27, done)
...
*BE + API* · read next: [docs/features/proactive.md](features/proactive.md) (updated 2026-08-26, complete)
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 40 IT + 0 unit
  ...
  - **populators:** `ActivityPopulator`, `ChallengePopulator`, `CheckInPopulator`, `CompanionMessagePopulator`,
    `DailySummaryPopulator`, `ExperimentPopulator`, `GoalPopulator`, `KnowledgeFactPopulator`, `MemoirPopulator`,
    `PatternPopulator`, `PredictionPopulator`, `QuestPopulator`, `SleepLogPopulator`, `TrainPopulator`,
    `UserPopulator`, `WeeklySuggestionPopulator`, `WeightLogPopulator`
