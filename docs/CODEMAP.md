...
> **Where things live.** Generated 2026-08-31 from commit `122b69da8`.
...
- **Contract** `api/feature/character/character.yml` — 7 operations
  - **endpoints:** GET /api/character · GET /api/character/dimension/{key} · GET /api/character/feed ·
    POST /api/character/bootstrap · GET /api/character/conference · POST /api/character/conference ·
    GET /api/character/conference/{conferenceId}
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 18 IT + 5 unit
  - **ITs:** `CharacterApiCompanionOffIT`, `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterBootstrapIT`,
    ...
    `CharacterPromptWiringIT`, `ClaimLifecycleIT`, `KonziliumProposalRoundIT`, `KonziliumVerdictRoundIT`
