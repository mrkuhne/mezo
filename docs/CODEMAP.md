...
> **Where things live.** Generated 2026-08-23 from commit `dccb0bbd`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 98 IT + 14 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `PeriodSummaryPersistenceIT`, `PeriodSummaryServiceIT`, `ProfilePropertiesIT`, `PromptMemoryAssemblerIT`,
