...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 198 IT + 38 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `AnchoredConversationIT`,
    ...
    `ChatMentionListenerIT`, `ChatReflectionBlockIT`, `ChatSeedReplyIT`, `ChatServiceAmbientRecallIT`,
    ...
    `ContextSnapshotAssemblerLifeGoalSwitchOffIT`, `ContextSnapshotAssemblerPeopleOffIT`, `ConversationServiceIT`,
    ...
    `LearnedFactPersistenceIT`, `LifeEventExtractionServiceIT`, `LifeGoalProposeNameIT`, `MeWeekControllerIT`,
