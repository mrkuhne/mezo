...
> **Where things live.** Generated 2026-08-22 from commit `0c407a9c`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 85 IT + 13 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `ChatExtractionFlowIT`, `ChatExtractionSwitchOffIT`,
    `ChatServiceAmbientRecallIT`, `ChatServiceGraphBlockIT`, `ChatServiceGraphBlockSwitchOffIT`, `ChatServiceIT`,
    ...
    `CompanionFeedbackApiIT`, `CompanionFeedbackSwitchOffIT`, `CompanionLlmFakeIT`, `CompanionMemoryLlmUsageApiIT`,
    ...
    `CompanionToolRegistryIT`, `CompanionToolsRenderIT`, `CompanionTranscribeApiIT`, `ContextSnapshotAssemblerIT`,
