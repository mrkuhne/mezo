...
> **Where things live.** Generated 2026-08-30 from commit `ad74dd23c`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/character`
  ...
  - **services:** `CharacterConferenceJob`, `CharacterConferenceService`, `CharacterCoreCatalog`,
    `CharacterExpertCatalog`, `CharacterHistoryReads`, `CharacterObservationJob`, `CharacterObservationService`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/character` — 11 IT + 4 unit
  - **ITs:** `CharacterApiIT`, `CharacterApiSwitchOffIT`, `CharacterConferenceJobIT`, `CharacterConferenceServiceIT`,
    `CharacterHistoryReadsIT`, `CharacterObservationJobIT`, `CharacterObservationServiceIT`, `CharacterPersistenceIT`,
    `ClaimLifecycleIT`, `KonziliumProposalRoundIT`, `KonziliumVerdictRoundIT`
