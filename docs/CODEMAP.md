...
> **Where things live.** Generated 2026-08-26 from commit `79a00d2b`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ConsolidationJob`,
    ...
    `PromptMemoryAssembler`, `Quarters`, `TranscriptionService`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 112 IT + 16 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `SleepLogDetailRenderIT`, `ToolSelectionEvalIT`, `TurnEmbeddingListenerIT`, `TurnEmbeddingSwitchOffIT`,
    `TurnVerdictCheckIT`
