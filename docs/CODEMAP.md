...
> **Where things live.** Generated 2026-08-21 from commit `a6658293`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **events/listeners:** `DecisionEmbeddingListener`, `JournalEmbeddingListener`, `ReflectionEmbeddingListener`,
