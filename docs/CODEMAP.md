...
*BE + API* · read next: [docs/features/admin-memory-explorer.md](features/admin-memory-explorer.md) (updated 2026-09-09, done) ·
  ...
  [docs/features/companion.md](features/companion.md) (updated 2026-09-16, mixed) ·
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `AdviceRankPort`, `ChatDaySignalService`, `ChatMemoryContextAdapter`, `ChatMentionListener`,
    ...
    `ObservationBudget`, `ObservationFeedService`, `ObservationSourceIcon`, `PatternConfirmedEvent`,
    `PatternDetectionJob`, `PatternDetectionService`, `PatternEventAppender`, `PatternGate`, `PatternImpactSource`,
    ...
    `TextSignalSeriesService`, `TextSignalService`, `TraceDisposition`, `TranscriptionService`, `TurnGear`,
    `TurnGearAnalyzer`, `TurnGearRouter`, `UnavailableReason`, `WeekContextRenderer`, `WeeklyScoreService`,
    `WeightByDateSupport`
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 214 IT + 69 unit
...
*FE-data + FE-ui* · read next: [docs/features/companion.md](features/companion.md) (updated 2026-09-16, mixed) ·
...
- **FE ui** `frontend/src/features/train`
  - **pages:** ActiveWorkoutPage.tsx, CustomWorkoutBuilderPage.tsx, ExercisesPage.tsx, ExercisesSkeleton.tsx,
    ...
    TrainTodayPage.tsx, TrainTodaySkeleton.tsx, TrainWeekJelekPage.tsx, TrainWeekMapPage.tsx, TrainWeekMozgasPage.tsx,
  ...
  - **components:** BodyMap.tsx, ChallengeCard.tsx, ChallengeGenerationLoader.tsx, CompactStepper.tsx,
    ...
    SportSessionCard.tsx, SportStat.tsx, StructureLintCard.tsx, TodaySessionCard.tsx, VideoDemo.tsx, WeekLoadPanel.tsx,
    WeekdayGrid.tsx, WeeklyBandsCard.tsx, WorkoutCard.tsx, WorkoutCeremony.tsx, WorkoutDock.tsx, WorkoutMenuGlass.tsx,
  ...
  - **logic:** actualDuration.ts, agenda.ts, bodyGeometry.gen.ts, bodyMapShapes.ts, cerScore.ts, dayImpact.ts,
    ...
    sportKinds.ts, sportMuscleLoad.ts, sportScore.ts, sports.ts, structureLint.ts, summaryStats.ts, tierLabel.ts,
