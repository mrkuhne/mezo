...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 146 IT + 22 unit
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/proactive` — 57 IT + 1 unit
