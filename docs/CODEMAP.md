...
> **Where things live.** Generated 2026-08-26 from commit `eb1181fa`.
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 115 IT + 16 unit
  - **ITs:** `AiMessageJsonbRoundTripIT`, `AmbientRecallEvalIT`, `AmbientRecallTuningIT`, `ChatExtractionFlowIT`,
    ...
    `QuarterlyReviewJobIT`, `QuarterlyReviewJobSwitchOffIT`, `QuarterlyReviewServiceIT`, `SleepLogDetailRenderIT`,
