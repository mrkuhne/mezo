...
> **Where things live.** Generated 2026-08-22 from commit `cd75b91e`.
...
- **Backend** `backend/src/main/java/io/mrkuhne/mezo/feature/companion`
  ...
  - **services:** `ChatService`, `ChatStreamService`, `ChatTurnCompleted`, `ContextSnapshotAssembler`,
    ...
    `KnowledgeFactPromotedEvent`, `KnowledgeFactService`, `LifeEventCandidateService`, `MemoryObservatoryService`,
...
- **Tests** `backend/src/test/java/io/mrkuhne/mezo/feature/companion` — 80 IT + 12 unit
