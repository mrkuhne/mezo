...
failed twice to produce a plan (thinking grew to 23 min/turn past ~60K context and tripped
Hermes's 900 s stale-stream watchdog), while **Qwen3.6-35B-A3B** delivered a full plan in
