...
# Üvegesítés U8 (mezo-me75u.8): Mezo I — dark-only, chrome from fuel-uveg.html, the shared 3D sprite (+ U8 new icons inline until the owner's OK).
{ cat src/uveg-mezo-head.html; printf "</head>\n<body>\n"; cat src/uveg-sprite-fuel.svg.part ../../../frontend/src/shared/ui/clay/titanium-icons.svg src/uveg-mezo-body.html; } > uveg-mezo.html
# Üvegesítés U9 (mezo-me75u.9): Mezo II — dark-only, chrome from fuel-uveg.html, the shared 3D sprite (+ U9 new icons inline until the owner's OK).
{ cat src/uveg-mezo2-head.html; printf "</head>\n<body>\n"; cat src/uveg-sprite-fuel.svg.part ../../../frontend/src/shared/ui/clay/titanium-icons.svg src/uveg-mezo2-body.html; } > uveg-mezo2.html
