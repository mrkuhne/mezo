...
# Üvegesítés U4 (mezo-me75u.4): Edzés I. Same chrome + the shared 3D sprite; the U4 icons ride in their own part until the owner's OK. Anatomy is imported from companion-titanium/ (module script, needs HTTP).
{ cat src/uveg-edzes-head.html; printf '</head>\n<body>\n'; cat src/uveg-sprite-fuel.svg.part ../../../frontend/src/shared/ui/clay/titanium-icons.svg src/uveg-edzes-uj-ikonok.svg.part src/uveg-edzes-body.html; } > uveg-edzes.html
