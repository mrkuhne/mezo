...
export const createFoodDay=()=>({meals:[
 {id:'seed-breakfast',time:'08:00',name:'Zabkása gyümölccsel',slot:'Reggeli',fixed:{kcal:420,p:22,c:64,f:9,fiber:7}},
 {id:'seed-lunch',time:'12:30',name:'Csirkés rizstál',slot:'Ebéd',fixed:{kcal:760,p:64,c:64,f:27,fiber:11}},
]});
let serial=0;
export const sampleDraft=()=>({id:`food-demo-${++serial}`,time:'15:30',items:[{key:'yogurt',grams:150},{key:'banana',grams:120}]});
export const fixedDraft=(name,fixed,time='15:30')=>({id:`food-demo-${++serial}`,time,name,fixed:{...fixed}});
...
const usualRows=[
 ...
 {name:'Banán és skyr',daypart:'nap',hint:'Uzsonna · a héten kétszer',fixed:{kcal:310,p:24,c:44,f:3,fiber:4},time:'16:20'},
 {name:'Zabkása gyümölccsel',daypart:'reggel',hint:'Reggeli · szinte minden nap',fixed:{kcal:420,p:22,c:64,f:9,fiber:7},time:'08:00'},
 {name:'Görög joghurt',daypart:'reggel',hint:'Reggeli · a héten háromszor',fixed:{kcal:240,p:20,c:9,f:11,fiber:0},time:'08:30'},
 {name:'Csirkés rizstál',daypart:'nap',hint:'Ebéd · heti négyszer',fixed:{kcal:760,p:64,c:64,f:27,fiber:11},time:'12:30'},
 {name:'Tojásos tortilla',daypart:'este',hint:'Vacsora · a héten kétszer',fixed:{kcal:750,p:38,c:52,f:34,fiber:6},time:'20:30'},
];
