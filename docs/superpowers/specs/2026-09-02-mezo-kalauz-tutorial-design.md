...
| **T2** | Fő aloldalak — Nap: üzenetek, rutin, küldetések, check-in, Életjel · Edzés: mai, heti, sport, futás, gyakorlatok, medálok, mezociklus-hub, aktív edzés (prep), review · Fuel: log, log/uj, terv, stack, receptek, kamra, gyógyszer, napló · Mezo: chat, minták, memoár, tudástár, előrejelzések, kísérletek, diagnózis, memória · Én: beállítások, growth, napló, heti hub, cél, súly, alvás, emberek, értesítések, karakter hub · Gyors logolás sheet (nem route: a `QuickInputSheet` első megnyitása triggereli, id `quickinput`) — **S3b-ben halasztva S4-re:** a motor egyetlen auto-open triggere a route-effekt, ehhez komponens-esemény seam kell (docs/features/tutorial.md §9) | ~32 | igen | 3–5 kártya |
