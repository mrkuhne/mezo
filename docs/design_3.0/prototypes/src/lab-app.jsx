...
export function Launcher() {
  ...
  return (
    <div className="lab-landing complete-landing">
      ...
      <a className="presence-study-entry" href="?v=hibrid"><strong>Hibrid · Mozaik fény + Titanium szerkezet + Boop</strong><span>A mostani világos világ, Titanium navigációval és pislogó Boop társsal →</span></a>
